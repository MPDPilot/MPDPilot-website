...
[X] Enter iOS App ID in `_config.yml`

[X] Upload video preview or screenshot

[X] Customise site in `_config.yml` (no HTML/CSS)

[X] Write Privacy Policy as markdown in `privacypolicy.md`

[X] Keep a changelog in `CHANGELOG.md`
